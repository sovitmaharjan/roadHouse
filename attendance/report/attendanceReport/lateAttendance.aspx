<%@ Page Title="" Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="true" CodeBehind="lateAttendance.aspx.cs" Inherits="attendance.report.attendanceReport.lateAttendance" %>
                ...
                <table id="" class="table table-striped table-bordered table-colored table-info">
                    <thead>
						<tr>
							...
							<th> Holiday </th>
							<th> WorkingDay </th>
							<th> Worked on Holiday </th>
							<th> Present Days </th>
							<th> Absent Days </th>
							<th> Paid Leave </th>
							<th> Unpaid Leave </th>
							<th> Total Worked Hours</th>
							<th> OT Worked Hours </th>
						</tr>
                    </thead>
                    <tbody>
                ...
                <form id="form" class="form-horizontal" runat="server">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <asp:DropDownList ID="list" CssClass="form-control" runat="server" required="required">
                                    <asp:ListItem Value="">Select</asp:ListItem>
                                    <asp:ListItem Value="1">Early Sign In Records</asp:ListItem>
                                    <asp:ListItem Value="2">Late  Sign In Records</asp:ListItem>
                                    <asp:ListItem Value="3">Early Sign Out Records</asp:ListItem>
                                    <asp:ListItem Value="4">Late Sign Out Records</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
