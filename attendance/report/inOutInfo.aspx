<%@ Page Title="" Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="true" CodeBehind="inOutInfo.aspx.cs" Inherits="attendance.report.inOutInfo" %>
                ...
                <table id="" class="table table-striped table-bordered table-colored table-info">
                    <thead>
						<tr>
							...
							<th style="text-align: center;" rowspan="2"> Emp ID </th>							
							<th rowspan="2"> Employee Name </th>										
							<th style="text-align: center;" colspan="2"> Shift 1</th>
							<th style="text-align: center;" colspan="2"> Shift 2</th>
						</tr>
						<tr>
							<th>InTime</th>
							<th>OutTime</th>
