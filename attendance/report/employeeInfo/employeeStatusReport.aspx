<%@ Page Title="" Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="true" CodeBehind="employeeStatusReport.aspx.cs" Inherits="attendance.report.employeeInfo.employeeStatusReport" %>
                ...
                <form id="form" class="form-horizontal" runat="server">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:DropDownList ID="status" CssClass="form-control" runat="server" required="required">
                                    ...
                                    <asp:ListItem Value="3">Discharged</asp:ListItem>
                                    <asp:ListItem Value="4">Dismiss</asp:ListItem>
