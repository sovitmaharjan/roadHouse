...
namespace attendance.report.employeeInfo {
    public partial class employeeDetailInformation : System.Web.UI.Page {
            ...
            if (!IsPostBack) {
                if (!string.IsNullOrEmpty(Request.Params["startDate"])) {
                    if (Request.Params["employeeId"] == "0") {
                        ...
                        heading.Text = "<b>" + Request.Params["startDate"] + " <span style='color: #797979;'>-to-</span> " + Request.Params["endDate"] + "</b><br/><b><span style='font-size: 14px; color: #797979;'>Employee: " + dtHeaderInfo.Rows[0]["emp_fullName"] + " (" + Request.Params["employeeId"] + ")</span></b><br/><b>Branch: " + dtHeaderInfo.Rows[0]["BRANCH_NAME"] + "</b><br /><b>Department: " + dtHeaderInfo.Rows[0]["DEPT_NAME"] + "</b>";
                    }
