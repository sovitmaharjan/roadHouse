<%@ Page Title="" Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="true" CodeBehind="branch.aspx.cs" Inherits="attendance.systemSetup.branch" %>
                ...
                <form id="form" class="form-horizontal" runat="server">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="branchCode" type="text" class="form-control" runat="server" autocomplete="off" required="required">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 control-label">
                ...
                $('.edit').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            $('#<%=branchCode.ClientID%>').val(result['BRANCH_CODE']);
                            if (result['sta'] == 1) {
