<%@ Page Title="" Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="true" CodeBehind="holidaySetup.aspx.cs" Inherits="attendance.systemSetup.publicHoliday.holidaySetup" %>
                ...
                <form id="form" class="form-horizontal" runat="server">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-group">
                                    <input autocomplete="off" type="text" id="startEnglishDate" name="fromEnglishDateForm" class="form-control datePickerForAll" placeholder="English Date" required="required" runat="server" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="branchName" type="text" class="form-control" runat="server" autocomplete="off" required="required">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">
                ...
                $('.edit').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            result = result.d[0];
                            $('#<%=id.ClientID%>').val(result['BRANCH_ID']);
                            $('#<%=branchName.ClientID%>').val(result['BRANCH_NAME']);
                            $('#<%=branchName.ClientID%>').val(result['BRANCH_CODE']);
                            if (result['sta'] == 1) {
